# ha-agent-rs [![Tests](https://github.com/Alekzanther/ha-agent-rs/actions/workflows/tests.yml/badge.svg)](https://github.com/Alekzanther/ha-agent-rs/actions/workflows/tests.yml)
